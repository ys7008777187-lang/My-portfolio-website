...
export default function DesignSystemPanel({ isOpen, onClose }) {
  const colors = [
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="ds-overlay" role="dialog" aria-modal="true" aria-labelledby="ds-title">
          <motion.div
          ...
          >
            <header className="ds-panel__header">
              <div>
                <h2 id="ds-title" className="ds-panel__title">Design System Showcase</h2>
                <p className="ds-panel__subtitle">Visual identity tokens & components for Basecamp 2026</p>
              </div>
              <button className="ds-panel__close" onClick={onClose} aria-label="Close Design System Panel">
            ...
            <div className="ds-panel__content">
              ...
              <section className="ds-section">
                <h3 className="ds-section__title">🎨 Colors & Design Tokens</h3>
              ...
              {/* Typography */}
              <section className="ds-section">
                <h3 className="ds-section__title">✍️ Typography (Plus Jakarta Sans)</h3>
              ...
              {/* Spacing */}
              <section className="ds-section">
                <h3 className="ds-section__title">📏 Spacing Scale (8px Grid Foundation)</h3>
              ...
              {/* Component Library */}
              <section className="ds-section">
                <h3 className="ds-section__title">🧩 Component Showcase</h3>
              ...
              <section className="ds-section ds-section--dark">
                <h3 className="ds-section__title">♿ Accessibility & Contrast (WCAG 2.2 AA)</h3>
