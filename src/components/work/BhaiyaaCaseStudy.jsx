            ...
            <section className={styles.hero}>
                ...
                >
                    <div className={`${styles.heroMockup} ${styles.mockupBack}`}>
                        <img src={getOptimizedUrl("/images/bhaiyaa/new_screen_3.jpg")} alt="Bhaiyaa Mart Screen" />
                    </div>
                    <div className={`${styles.heroMockup} ${styles.mockupFront}`}>
                        <img src={getOptimizedUrl("/images/bhaiyaa/new_screen_1.jpg")} alt="Bhaiyaa Home Screen" />
                    </div>
                </motion.div>
            </section>
                    ...
                    <div className={styles.mockupGrid} style={{ marginTop: '40px' }}>
                        {[
                            ...
                            <div key={i} className={styles.mockupCard}>
                                <img src={getOptimizedUrl(screen.src)} alt={screen.alt} className={styles.mockupImage} />
                            </div>
                        ))}
                    </div>
                </section>
