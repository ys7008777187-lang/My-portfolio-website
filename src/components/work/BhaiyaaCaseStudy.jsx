            ...
            <section className={styles.hero}>
                ...
                >
                    <div className={`${styles.heroMockup} ${styles.mockupBack}`}>
                        <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/public/images/bhaiyaa/new_screen_3.jpg")} alt="Bhaiyaa Mart Screen" />
                    </div>
                    <div className={`${styles.heroMockup} ${styles.mockupFront}`}>
                        <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/public/images/bhaiyaa/new_screen_1.jpg")} alt="Bhaiyaa Home Screen" />
                    </div>
                </motion.div>
            </section>
            ...
            <div className={styles.contentWrapper}>
                ...
                <section className={styles.section} id="journey">
                    ...
                    <div className={styles.mockupGrid} style={{ marginTop: '40px' }}>
                        {[
                            { src: 'https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/public/images/bhaiyaa/new_screen_1.jpg', alt: 'Discovery' },
                            { src: 'https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/public/images/bhaiyaa/new_screen_3.jpg', alt: 'Service Selection' },
                            { src: 'https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/public/images/bhaiyaa/new_screen_5.jpg', alt: 'Checkout' },
                        ].map((screen, i) => (
