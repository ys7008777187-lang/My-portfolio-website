                        ...
                        <div className={styles.heroMockupContainer}>
                            <div className={styles.laptopMockup} style={{marginTop: '0', marginBottom: '0', width: '100%', maxWidth: 'none'}}>
                                <div className={styles.heroLaptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/Home.jpg")} alt="ADT Solution Landing Page" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className={styles.boxCard}>
                            ...
                            <div className={styles.laptopMockup} style={{marginTop: '32px', margin: '32px auto 0', maxWidth: '100%'}}>
                                <div className={styles.laptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/About us.jpg")} alt="Content Re-write" />
                                </div>
                            </div>
                    ...
                    <div className={styles.imageGrid}>
                        <div className={styles.imageWrapper} style={{background: 'transparent', border: 'none', padding: 0}}>
                            <div className={styles.laptopMockup} style={{marginTop: '0px', width: '100%'}}>
                                <div className={styles.laptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/Payroll.jpg")} alt="ADT Global Payroll UI" />
                                </div>
                            </div>
                        ...
                        <div className={styles.imageWrapper} style={{background: 'transparent', border: 'none', padding: 0}}>
                            <div className={styles.laptopMockup} style={{marginTop: '0px', width: '100%'}}>
                                <div className={styles.laptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/EOR.jpg")} alt="ADT Employer of Record UI" />
                                </div>
                            </div>
                        ...
                        <div className={styles.imageWrapper} style={{background: 'transparent', border: 'none', padding: 0}}>
                            <div className={styles.laptopMockup} style={{marginTop: '0px', width: '100%'}}>
                                <div className={styles.laptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/Immigration.jpg")} alt="ADT Immigration Flow" />
                                </div>
                            </div>
                ...
                <section className={styles.section} id="improvements">
                    ...
                    <div className={styles.improvementRow}>
                        ...
                        <div className={styles.solutionState}>
                            ...
                            <div className={styles.laptopMockup} style={{marginTop: '32px', margin: '32px auto 0', maxWidth: '100%'}}>
                                <div className={styles.laptopScreen}>
                                    <img src={getAssetUrl("https://pub-5595d92cf36742b8a68ec73826bbecab.r2.dev/images/ADT/Pricing.jpg")} alt="ADT Pricing Tables Redesigned" />
                                </div>
                            </div>
                        </div>
                    </div>
